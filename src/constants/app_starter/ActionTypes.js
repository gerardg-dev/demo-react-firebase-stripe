...
export const RESET_PASSWORD_EMAIL_LINK_SENT = "reset_password_email_link_sent";
export const VERIFY_EMAIL_LINK_SENT = "verify_email_link_sent";
export const AUTH_USER = "auth_user";
export const USER_DOC = "user_doc";
...
export const STRIPE_CUSTOMER_SOURCES = "stripe_customer_sources";
export const STRIPE_CUSTOMER_CHARGES = "stripe_customer_charges";
export const STRIPE_CUSTOMER_SUBSCRIPTIONS = "stripe_customer_subscriptions";

export const STRIPE_CUSTOMERS = "stripe_customers";
export const STRIPE_CHARGES = "stripe_charges";
export const STRIPE_SUBSCRIPTIONS = "stripe_subscriptions";

export const STRIPE_LOADER = "stripe_loader";
export const STRIPE_ERROR = "stripe_error";

// APP-OBBERS

export const SIGNUP_EMPLOYER = "signup_employer";
export const SIGNUP_EMPLOYEE = "signup_employee";

export const SIGNIN_EMPLOYER = "signin_employer";
...
export const EXAMPLES_PAGINATION = "examples_pagination";
