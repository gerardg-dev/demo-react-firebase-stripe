...
import Header from "components/materialUI/Header/index";
import Sidebar from "containers/app_starter/SideNav/index";
...
import Tour from "components/materialUI/Tour/index";
import {
  ABOVE_THE_HEADER,
  BELOW_THE_HEADER,
  COLLAPSED_DRAWER,
...
import ColorOption from "containers/app_starter/Customizer/ColorOption";
import { isIOS, isMobile } from "react-device-detect";
import asyncComponent from "../../util/asyncComponent";
import TopNav from "components/materialUI/TopNav";
          ...
          <main className="app-main-content-wrapper">
            <div className="app-main-content">
              <Switch>
                ...
                <Route
                  component={asyncComponent(() =>
                    import("app/app_starter/routes/extraPages/routes/404")
                  )}
                />
                <Route
                  component={asyncComponent(() =>
