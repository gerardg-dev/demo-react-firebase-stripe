      ...
      <div className="row">
        ...
        <div className="col-xl-2 col-md-3 col-sm-4">
          <div className="row">
            <div className="col-sm-6 col-4">
              <IconCard image={require('assets/app_starter/images/widget/noodles.png')}/>
            </div>
            <div className="col-sm-6 col-4">
              <IconCard image={require('assets/app_starter/images/widget/disc.png')}/>
            </div>
            <div className="col-sm-6 col-4 d-sm-none">
              <IconCard color="bg-secondary" image={require('assets/app_starter/images/widget/glass.png')}/>
            </div>
        ...
        <div className="col-xl-2 col-md-3 col-sm-4">
          <div className="row">
            ...
            <div className="col-6 d-none d-sm-block">
              <IconCard color="bg-primary" image={require('assets/app_starter/images/widget/bread.png')}/>
            </div>
          </div>
        </div>
