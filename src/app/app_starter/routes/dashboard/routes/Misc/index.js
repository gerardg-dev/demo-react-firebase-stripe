...
import {chartDataWithoutAxis} from 'app/app_starter/routes/dashboard/routes/ECommerce/data'
...
import InfoCard from 'components/materialUI/InfoCard';
import InFoWithBgImage from 'components/materialUI/InFoWithBgImage';
import UserDetailCard from 'components/materialUI/UserDetailCard';
...
import ContactCard from 'components/materialUI/Cards/Contact';
...
import {
  ...
  marketingData,
  products
} from 'app/app_starter/routes/dashboard/routes/Misc/data';
...
import Team from 'app/app_starter/routes/extraPages/routes/aboutUs/Componets/Team';
import CardHeader from 'components/materialUI/dashboard/Common/CardHeader/index';
import IntlMessages from 'util/IntlMessages';
import {CircularProgressbar} from "react-circular-progressbar";
import 'react-circular-progressbar/dist/styles.css';
import './test.css'
import GradientSVG from "app/app_starter/routes/dashboard/routes/Misc/GradientSVG";
import CustomLineChart from "components/materialUI/CustomLineChart/index";
import {Progress} from "reactstrap";
import MapWithASearchBox from "app/app_starter/routes/map/routes/MapWithSearchBox/Components/MapWithASearchBox";
import HorizontalItemCard from "components/materialUI/dashboard/Common/HorizontalItemCard";
          ...
          <div className="col-lg-2 col-sm-4 col-12">
            <div className="jr-card bg-gradient-primary text-white text-center">
              <div className="mb-3 mt-xl-1">
                <img src={require("assets/app_starter/images/dashboard/download.png")} alt="download1"/>
              </div>
