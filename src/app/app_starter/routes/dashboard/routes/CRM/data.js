...
export const detailCards = [
  {
    cardColor: 'primary',
    imageIcon: require('assets/app_starter/images/dashboard/project-icon.png'),
    title: '09',
    subTitle: 'Projects'
  }, {
    cardColor: 'secondary',
    imageIcon: require('assets/app_starter/images/dashboard/tasks-icon.png'),
    title: '457',
    subTitle: 'Tasks'
  }, {
    cardColor: 'info',
    imageIcon: require('assets/app_starter/images/dashboard/teams-icon.png'),
    title: '247',
    subTitle: 'Teams'
  }, {
    cardColor: 'warning',
    imageIcon: require('assets/app_starter/images/dashboard/files-icon.png'),
    title: '09',
    subTitle: 'Files'
  },
]
