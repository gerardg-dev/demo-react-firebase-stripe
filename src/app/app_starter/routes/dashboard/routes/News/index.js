...
import PopularArticles from 'components/materialUI/dashboard/news/PopularArticals';
import MarketingTable from 'components/materialUI/dashboard/Common/MarketingTable';
import StoryOfTheDay from 'components/materialUI/dashboard/news/StoryOfTheDay';
import Comments from 'components/materialUI/dashboard/news/CommentsTable';
import LatestNotifications from 'components/materialUI/dashboard/Common/LatestNotifications';
import ReportBox from 'components/materialUI/ReportBox/index';
import ContainerHeader from 'components/materialUI/ContainerHeader/index';
import SiteTraffic from 'components/materialUI/dashboard/news/SiteTraffic';
import YourDailyFeed from 'components/materialUI/dashboard/news/YourDailyFeed';
