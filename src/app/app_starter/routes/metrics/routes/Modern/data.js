...
export const dataMetrics = [
  {
    ...
    imageIcon: require('assets/app_starter/images/dashboard/shopping-bag-icon.png')
  }, {
    title: '29,380',
    subTitle: 'Revenue this year',
    imageIcon: require('assets/app_starter/images/dashboard/rich-icon.png')
  }, {
    title: '2,870',
    subTitle: 'Visits this year',
    imageIcon: require('assets/app_starter/images/dashboard/mouse-icon.png')
  }, {
    title: '8,380',
    subTitle: 'Queries this year',
    imageIcon: require('assets/app_starter/images/dashboard/contact-icon.png')
  }
];
...
export const commerceStatus = [
  {
    ...
    colorSubTitle: 'white',
    color: 'primary',
    imageIcon: require('assets/app_starter/images/dashboard/shopping-bag-icon-sm.png')
  }, {
    title: '29,380',
    colorTitle: 'white',
    subTitle: 'Revenue this year',
    colorSubTitle: 'white',
    color: 'secondary',
    imageIcon: require('assets/app_starter/images/dashboard/rich-icon-sm.png')
  }, {
    title: '2,870',
    colorTitle: 'indigo',
    subTitle: 'Visits this year',
    colorSubTitle: 'grey',
    color: '',
    imageIcon: require('assets/app_starter/images/dashboard/mouse-icon-sm.png')
  }
];
