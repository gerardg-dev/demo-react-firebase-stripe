...
import {cardData, cardData1, cardData2, cardData3, data1} from 'app/app_starter/routes/dashboard/routes/data'
import {data, data2, radarChartData} from 'app/app_starter/routes/dashboard/routes/ECommerce/data'
import {chartData, lineChartData, pieChartData} from 'app/app_starter/routes/dashboard/routes/News/data';
...
import CardHeader from 'components/materialUI/dashboard/default/CardHeader';
...
import SaleBox from "components/materialUI/SaleBox/index";
        ...
        <div className="row">
          ...
          <div className="col-xl-3 col-lg-6 col-md-3 col-sm-6 col-12">
            <div className="jr-card bg-primary text-white text-center py-5">
              <div className="mb-3">
                <img src={require("assets/app_starter/images/dashboard/download.png")} alt="downloadImage"/>
              </div>
