      ...
      <div style={styleObjects.container}>
        <div style={styleObjects.examplesContainer}>
          ...
          <a
            ...
            href="https://github.com/gerardg-dev/demo-stripe-elements"
            target="_blank"
          >
            {"SEE REPO"}
          </a>
          ...
          <a
            style={styleObjects.button}
            href={
              demosURLs.components.wedevlopUI.stripeElements.ops.attachSource
            }
            target="blank"
          >
            {"ATTACH A SOURCE"}
          ...
          <a
            style={styleObjects.button}
            href={
              demosURLs.components.wedevlopUI.stripeElements.ops.createCharge
            }
            target="blank"
          >
            {"CREATE A CHARGE"}
          ...
          <a
            style={styleObjects.button}
            href={
              demosURLs.components.wedevlopUI.stripeElements.ops
                .createSubscription
            }
            target="blank"
          >
          ...
          <a
            style={styleObjects.button}
            href={demosURLs.components.wedevlopUI.stripeElements.api.customer}
            target="_blank"
          >
            {"SEE CUSTOMER"}
          </a>
          ...
          <a
            style={styleObjects.button}
            href={demosURLs.components.wedevlopUI.stripeElements.api.charges}
            target="_blank"
          >
            {"SEE CHARGES"}
          </a>
          ...
          <a
            style={styleObjects.button}
            href={
              demosURLs.components.wedevlopUI.stripeElements.api.subscriptions
            }
            target="_blank"
          >
            {"SEE SUBSCRIPTIONS"}
