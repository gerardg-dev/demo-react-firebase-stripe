...
import { attachSource } from "../../../../../../thunks/app_starter/Firebase/Stripe";
...
class AttachSource extends Component {
  componentDidMount() {
    ...
    return (
      <div style={styleObjects.container}>
        <div style={styleObjects.examplesContainer}>
          ...
          />
          <SeeCodeButton href="https://carbon.now.sh/Xeu4UZXl62Lg2nmygGCa" />
          <a
...
export default connect(mapStateToProps, { attachSource })(AttachSource);

AttachSource.defaultProps = {
  attachFun: () => console.log("AttachSource - attachFun()")
};
