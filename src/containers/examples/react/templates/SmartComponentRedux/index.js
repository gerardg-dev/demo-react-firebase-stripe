...
/**
 * Documentation
 * ExampleReduxClassBasedComponent
 *
 * Default Props
...
class ExampleReduxClassBasedComponent extends Component {
  constructor(props) {
    super(props);
    this.state = { testStateValue: 1 };
  }
  ...
  render() {
    const { backgroundColor, addContainerStyle, children } = this.props;
    const { testStateValue } = this.state;
...
ExampleReduxClassBasedComponent.defaultProps = {
