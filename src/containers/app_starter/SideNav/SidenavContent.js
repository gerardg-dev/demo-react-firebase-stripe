    ...
    return (
      <CustomScrollbars className=" scrollbar">
        <ul className="nav-menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  ...
                  to="/app-sample/dashboard/crypto"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/dashboard/listing"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/dashboard/intranet"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/dashboard/eCommerce"
                >
          ...
          <li className="ui_tooltip menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/alerts"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/appbar"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/auto-complete"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/avatars"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/badges"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/bottom-navigation"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/breadcrumbs"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/buttons"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/button-group"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/cards"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/carousel"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/chips"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/color-picker"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/dialogs"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/dividers"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/expansion-panel"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/drawer"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/grid-list"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/menu-paper"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/pickers"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/popovers"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/progressbar"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/selects"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/selection"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/snackbar"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/stepper"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/tables"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/text-fields"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/tooltips"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/components/typography"
                >
                  <span className="nav-text">
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/to-do-redux">
              <i className="zmdi zmdi-check-square zmdi-hc-fw" />
              <span className="nav-text">
                <IntlMessages id="sidebar.appModule.toDo" />
              </span>
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/mail-redux">
              <i className="zmdi zmdi-email zmdi-hc-fw" />
              <span className="nav-text">
                <IntlMessages id="sidebar.appModule.mail" />
              </span>
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/chat-redux">
              <i className="zmdi zmdi-comment zmdi-hc-fw" />
              <span className="nav-text">
                <IntlMessages id="sidebar.appModule.chat" />
              </span>
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/contact-redux">
              <i className="zmdi zmdi-account-box zmdi-hc-fw" />
              <span className="nav-text">
                <IntlMessages id="sidebar.appModule.contact" />
              </span>
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/social-apps/profile">
              <i className="zmdi zmdi-account-box zmdi-hc-fw" />
              <span className="nav-text">
          ...
          <li className="menu no-arrow">
            <NavLink to="/app-sample/social-apps/wall">
              <i className="zmdi zmdi-account-box zmdi-hc-fw" />
              <span className="nav-text">
          ...
          <li className="menu collapse-box">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app-sample/table/basic">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/table/data">
                  <span className="nav-text">
          ...
          <li className="timeline_tooltip menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/time-line/default"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/time-line/default-with-icon"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/time-line/left-align"
                >
                  <span className="nav-text">
              ...
              {/*<li>
                            <NavLink className="prepend-icon" to="/app-sample/time-line/zigzag">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/custom-views/simple-list"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/custom-views/strip-list"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/custom-views/card-list"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/form/stepper">
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app-sample/editor/ck">
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/pickers/date-time"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extensions/dropzone"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extensions/sweet-alert"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extensions/notification"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/line">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/bar">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/area">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/pie">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/radial">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/chart/radar">
                  <span className="nav-text">
          ...
          <li className="map_tooltip menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/simple">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/styled">
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/map/geo-location"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/overlay">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/kml">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/traffic">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/event">
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/map/drawing">
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/calendar/cultures"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink className="prepend-icon" to="/app-sample/calendar/dnd">
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/calendar/rendering"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/calendar/selectable"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/calendar/timeslots"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/ecommerce/products-list"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/ecommerce/products-grid"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/login-1"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/login-2"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/login-with-stepper"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/sign-up-1"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/sign-up-2"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/forgot-password-1"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/forgot-password-2"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/lock-screen-1"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/app-module/lock-screen-2"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-elements/pricing-table"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-elements/callouts"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-elements/testimonials"
                >
                  <span className="nav-text">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/about-us"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/contact-us"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/blog"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/portfolio"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/error-404"
                >
                  <span className="nav-text">
              ...
              <li>
                <NavLink
                  className="prepend-icon"
                  to="/app-sample/extra-pages/error-500"
                >
                  <span className="nav-text">
