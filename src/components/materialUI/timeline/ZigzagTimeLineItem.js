    ...
    <div className={`timeline-item ${styleName}`}>
      <div className="timeline-badge timeline-img">
        {styleName.includes("timeline-inverted") ?
          <img className="size-60" src={require("assets/app_starter/images/pentagon_1.png")} alt="Pentagon" title="Pentagon"/> :
          <img className="size-60" src={require("assets/app_starter/images/pentagon.png")} alt="Pentagon" title="Pentagon"/>}
      </div>
