...
class MediaInput extends Component {
  ...
  handleUploadFile = async uploadFileHandler => {
    try {
  ...
  renderCropContent = uploadFileHandler => {

    {files.length > 0 && (
      this.setState({ showCropModal: true });
      if (this.state.showCropModal === true) {
        // if (isFiles) {
        //   return (
        //     <img
        //       src={files[0].preview}
            ...
            >
              ...
              {files.length > 0 && (
                <div>
                  ...
                  <button
                    // onClick={handleUploadFile(uploadFileHandler)}
                    onClick={() => handleUploadFile(uploadFileHandler)}
  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.renderCropContent(uploadFileHandler)}
        {/*
          files.length > 0 && (
          <img
            src={files[0].preview}
