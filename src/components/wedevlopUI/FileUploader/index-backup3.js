...
//   // const [cropModalDisplay, setCropModalDisplay] = useState("flex");
//
//   useEffect(() => {
//     return () => {
...
//     //
//     // if (files.length > 0) {
//     //   let shouldCrop = showCropModal ? "" : setShowCropModal(true);
//     //   // setShowCropModal(true);
//     //   if (showCropModal === false) {
//     //     setShowCropModal(true);
//     //   }
//     // }
//     //
